...
export const Legend: React.FC = () => {
  const items = [
    ...
    { label: 'Modifier', color: 'bg-blue-900/50 border-blue-700' },
    { label: 'Layer', color: 'bg-orange-900/50 border-orange-700' },
    { label: 'Special', color: 'bg-yellow-900/50 border-yellow-700' },
